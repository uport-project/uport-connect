          ...
          profile => {
            expect(
              uriHandler.calledWith(
                `me.uport:me?network_id=0x4&label=UportTests&callback_url=https%3A%2F%2Fchasqui.uport.me%2Fapi%2Fv1%2Ftopic%2F123&client_id=${CLIENT_ID}`
              ),
      ...
      it("requests public profile", () => {
        ...
        return uport.requestCredentials().then(
          profile => {
            ...
            expect(
              uriHandler.calledWith(
                `me.uport:me?requestToken=${REQUEST_TOKEN}`
              ),
              uriHandler.lastCall.args[0]
            ).to.be.true;
          },
    ...
    it("requests public profile and current network", () => {
      ...
      return uport.requestCredentials().then(
        profile => {
          ...
          expect(
            uriHandler.calledWith(`me.uport:me?requestToken=${REQUEST_TOKEN}`),
            uriHandler.lastCall.args[0]
          ).to.be.true;
        },
        error => {
    ...
    it("returns address for specific network", () => {
      ...
      return uport.requestAddress().then(
        address => {
          ...
          expect(
            uriHandler.calledWith(
              `me.uport:me?network_id=0x2a&label=UportTests&callback_url=https%3A%2F%2Fchasqui.uport.me%2Fapi%2Fv1%2Ftopic%2F123&client_id=${CLIENT_ID}`
            ),
            uriHandler.lastCall.args[0]
          ).to.be.true;
        },
    ...
    it("provides attestation to user using default uriHandler", () => {
      ...
      return uport.attestCredentials(PAYLOAD).then(
        result => {
          ...
          expect(
            uriHandler.calledWith(
              `me.uport:add?attestations=${ATTESTATION}&callback_url=https%3A%2F%2Fchasqui.uport.me%2Fapi%2Fv1%2Ftopic%2F123`
            ),
            uriHandler.lastCall.args[0]
          ).to.be.true;
        },
    ...
    it("shows simple value url", () => {
      ...
      return uport.sendTransaction({ to: CONTRACT, value: "0xff" }).then(
        txhash => {
          ...
          expect(
            uriHandler.calledWith(
              `me.uport:2opgxRd4H4WHiZwxGzGQr4HG942X12d39LJ?value=255&label=UportTests&callback_url=https%3A%2F%2Fchasqui.uport.me%2Fapi%2Fv1%2Ftopic%2F123&client_id=${CLIENT_ID}`
            ),
            uriHandler.lastCall.args[0]
          ).to.be.true;
        },
      ...
      return uport
        ...
        .then(
          txhash => {
            ...
            expect(
              uriHandler.calledWith(
                `me.uport:2opgxRd4H4WHiZwxGzGQr4HG942X12d39LJ?value=255&function=transfer(address%200x3b2631d8e15b145fd2bf99fc5f98346aecdc394c%2Cuint%2012312)&label=UportTests&callback_url=https%3A%2F%2Fchasqui.uport.me%2Fapi%2Fv1%2Ftopic%2F123&client_id=${CLIENT_ID}`
              ),
              uriHandler.lastCall.args[0]
            ).to.be.true;
          },
      ...
      return uport
        ...
        .then(
          txhash => {
            ...
            expect(
              uriHandler.calledWith(
                `me.uport:2opgxRd4H4WHiZwxGzGQr4HG942X12d39LJ?value=255&bytecode=abcdef01&label=UportTests&callback_url=https%3A%2F%2Fchasqui.uport.me%2Fapi%2Fv1%2Ftopic%2F123&client_id=${CLIENT_ID}`
              ),
              uriHandler.lastCall.args[0]
            ).to.be.true;
          },
      ...
      return uport
        ...
        .then(
          txhash => {
            ...
            expect(
              uriHandler.calledWith(
                `me.uport:2opgxRd4H4WHiZwxGzGQr4HG942X12d39LJ?value=255&bytecode=abcdef01&label=UportTests&callback_url=https%3A%2F%2Fchasqui.uport.me%2Fapi%2Fv1%2Ftopic%2F123&client_id=${CLIENT_ID}&gasPrice=0x4444`
              ),
              uriHandler.lastCall.args[0]
            ).to.be.true;
          },
      ...
      return token
        ...
        .then(
          txhash => {
            ...
            expect(
              uriHandler.calledWith(
                `me.uport:2opgxRd4H4WHiZwxGzGQr4HG942X12d39LJ?function=transfer(address%200x3b2631d8e15b145fd2bf99fc5f98346aecdc394c%2C%20uint256%2012312)&label=UportTests&callback_url=https%3A%2F%2Fchasqui.uport.me%2Fapi%2Fv1%2Ftopic%2F123&client_id=${CLIENT_ID}`
              ),
              uriHandler.lastCall.args[0]
            ).to.be.true;
          },
